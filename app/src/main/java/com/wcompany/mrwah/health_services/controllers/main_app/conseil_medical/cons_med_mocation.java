...
public class cons_med_mocation extends AppCompatActivity implements OnMapReadyCallback {

    private static final String TAG = cons_med_mocation.class.getSimpleName();
    ...
    private Toolbar edit_profile_toolbar;
